  ...
  head: () => ({
    meta: [
      ...
      { title: "IBASE Technologies | ICT Infrastructure Nigeria" },
      {
        name: "description",
        content:
          "IBASE Technologies Ltd delivers networking, connectivity, telecommunications and IT infrastructure solutions across Nigeria.",
      },
      { name: "author", content: "IBASE Technologies Ltd" },
